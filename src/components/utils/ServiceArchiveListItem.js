      ...
      <View
        ...
        <View style={Styles.firstRowContainerStyle}>
          <View style={Styles.singleItemStyle}>
            <Text style={{color: getStateColor(Item.State), fontSize: normalize(12), fontFamily:getFontsName("IRANSansMobile_Medium")}}>
              {getState(Item.State)}
            </Text>
            <Text style={{fontSize: normalize(13), fontFamily:getFontsName("IRANSansMobile_Medium")}}>وضعیت: </Text>
          </View>
          <View style={Styles.singleItemStyle}>
        ...
        <View style={Styles.firstRowContainerStyle}>
          ...
          <View style={Styles.singleItemStyle}>
            <Text style={{fontSize: normalize(13), fontFamily:getFontsName("IRANSansMobile_Light")}}>{toFaDigit(Item.cell)}</Text>
